...
# Add python-polcoinrpc to module search path:
import os
import sys
sys.path.append(os.path.join(os.path.dirname(os.path.abspath(__file__)), "python-polcoinrpc"))
...
def initialize_datadir(dirname, n):
    ...
    if not os.path.isdir(datadir):
        os.makedirs(datadir)
    with open(os.path.join(datadir, "polcoin.conf"), 'w') as f:
        f.write("regtest=1\n");
        f.write("rpcuser=rt\n");
...
def initialize_chain(test_dir):
    ...
    if not os.path.isdir(os.path.join("cache", "node0")):
        ...
        for i in range(4):
            ...
            subprocess.check_call([ os.getenv("POLCOINCLI", "polcoin-cli"), "-datadir="+datadir,
    ...
    for i in range(4):
        ...
        initialize_datadir(test_dir, i) # Overwrite port/rpcport in polcoin.conf
...
def start_node(i, dirname, extra_args=None, rpchost=None):
    ...
    args = [ os.getenv("POLCOIND", "polcoind"), "-datadir="+datadir, "-keypool=1", "-discover=0", "-rest" ]
