The following is a list of assets used in the polcoin source and their proper attribution.
...
* License: MIT
* Site: [https://polcointalk.org/index.php?topic=15276.0](https://polcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original polcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/polcoin.icns, src/qt/res/src/polcoin.svg,
	src/qt/res/src/polcoin.ico, src/qt/res/src/polcoin.png,
	src/qt/res/src/polcoin_testnet.png, docs/polcoin_logo_doxygen.png,
