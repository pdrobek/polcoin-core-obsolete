Download URL: https://sourceforge.net/projects/polcoin/files/Polcoin/polcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 PLC fee schedule (users still pay 0.01 PLC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #polcoin00 - #polcoin99
