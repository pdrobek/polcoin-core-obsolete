Polcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/polcoin/files/Polcoin/polcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Polcoin
...
New/changed settings (command-line or polcoin.conf file)
--------------------------------------------------------
