Polcoin Core version 0.9.4 is now available from:

  https://polcoin.org/bin/0.9.4/
...
this update is incompatible with the Polcoin system and could lead to consensus
forks.

Polcoin Core released binaries from https://polcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~polcoin/+archive/ubuntu/polcoin
- A third-party or self-compiled Polcoin Core

upgrade to Polcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
