Polcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/polcoin/files/Polcoin/polcoin-0.5.4/
...
http://gitorious.org/polcoin/polcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Remove wxPolcoin properly when installing Polcoin-Qt over it. (Windows)
