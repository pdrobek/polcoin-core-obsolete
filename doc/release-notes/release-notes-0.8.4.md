Polcoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/polcoin/files/Polcoin/polcoin-0.8.4/
...
guess attempts; fixes https://github.com/polcoin/polcoin/issues/2838
(CVE-2013-4165)
...
Linux: clicking on polcoin: links was broken if you were using
a Gnome-based desktop.

Fix a hang-at-shutdown bug that only affects users that compile
their own version of Polcoin against Boost versions 1.50-1.52.
