Polcoin Core version 0.9.2.1 is now available from:

  https://polcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 PLC to 0.01 PLC
...
- Fix "Start polcoin on system login"
