/* src/config/polcoin-config.h.  Generated from polcoin-config.h.in by configure.  */
/* src/config/polcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef POLCOIN_CONFIG_H

#define POLCOIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "info@polcoin.org"
