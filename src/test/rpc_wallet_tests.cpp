...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CPolcoinAddress demoAddress = CPolcoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CPolcoinAddress setaccountDemoAddress = CPolcoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
