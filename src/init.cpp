 ...
 */
static const char* BITCOIN_PID_FILENAME = "polcoind.pid";
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Rav3nPL/polcoin>";
    const std::string URL_WEBSITE = "<https://polcoin.pl>";
