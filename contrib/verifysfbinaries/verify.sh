...
###   This script attempts to download the signature file SHA256SUMS.asc from polcoin.org
...
WORKINGDIR="/tmp/polcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://polcoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://polcoin.org/bin/"
VERSIONPREFIX="polcoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'polcoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[polcoin-]<version>-[rc[0-9]] (example: polcoin-0.9.2-rc1)"
   echo "wget output:"
